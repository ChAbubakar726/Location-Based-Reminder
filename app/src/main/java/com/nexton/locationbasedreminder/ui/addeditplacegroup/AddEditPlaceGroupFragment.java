package com.nexton.locationbasedreminder.ui.addeditplacegroup;
...
import com.nexton.locationbasedreminder.ui.views.ColorfulChip;
...
import com.nexton.locationbasedreminder.viewmodel.AddEditPlaceGroupFragmentViewModel;
...
public class AddEditPlaceGroupFragment extends AddEditFragment {
    ...
    public static final String BUNDLE_KEY_PLACE_GROUP = "com.nexton.locationbasedreminder.BUNDLE_KEY_PLACE_GROUP";
    ...
    private void setObserver() {
        viewModel.getSelectedPlace().observe(getViewLifecycleOwner(), selectedPlace -> {
